module.exports = Object.freeze({
  ...
  GET_ALL_EXPENSES_FOR_A_PROJECT:
    'SELECT * from "Expense" where "E_PR_ID" = $1;',
  GET_ALL_REVENUES_FOR_A_PROJECT: `SELECT * from "Revenue" where "R_ProjectWorkOrderNumber" = $1;`,
  ...
  GET_TOTAL_UNMAPPED_PAYMENT_AMOUNT_FOR_LIST_OF_INVOICE_NUMBERS: `SELECT SUM("P_TotalAmount") FROM "Payment" where "P_InvoiceNumber" = ANY($1) AND "P_IsMappedOrUnmapped" = false;`,
});
