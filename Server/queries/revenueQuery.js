module.exports = Object.freeze({
  ...
  GET_ALL_REVENUES_FOR_A_PROJECT: `SELECT to_char("R_ClientInvoiceDate", 'YYYY-MM-DD') as "R_ClientInvoiceDateInFormat", * FROM "Revenue" where "R_ProjectWorkOrderNumber" = $1;`,
  ...
  GET_REVENUE_FROM_CUSTOMER_INVOICE_NUMBER: `SELECT * FROM "Revenue" where "R_CustomerInvoiceNumber" = $1;`,
